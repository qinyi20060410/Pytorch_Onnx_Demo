...
//! \class Logger
//!
//! \brief Class which manages logging of TensorRT tools and Trt
//!
//! \details This class provides a common interface for TensorRT tools and Trt
//! to log information to the console, and supports logging two types of
//! messages:
//!
...
//!
//! The advantage of having all Trt use this class for logging as opposed to
//! emitting directly to stdout/stderr is that the logic for controlling the
//! verbosity and formatting of Trt output is centralized in one location.
//!
...
//!
//! TODO: For backwards compatibility with existing Trt, this class inherits
...
//! library and messages coming from the Trt.
//!
//! In the future (once all Trt are updated to use Logger::getTRTLogger() to
...
class Logger : public nvinfer1::ILogger {
 public:
  ...
  //! this Logger
  //!
  //! TODO Once all Trt are updated to use this method to register the logger
  //! with TensorRT, we can eliminate the inheritance of Logger from ILogger
  //!
  ...
  //!
  //! Note Trt should not be calling this function directly; it will eventually
  //! go away once we eliminate the inheritance from nvinfer1::ILogger
  //!
  ...
  //! test results. The Trt must call Logger::defineTest() in order to obtain a
  //! TestAtom that can be used with Logger::reportTest{Start,End}().
  //!
  class TestAtom {
   public:
