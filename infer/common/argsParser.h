...
//!
//! \brief The TrtParams structure groups the basic parameters required by
//!        all Trt networks.
//!
struct TrtParams {
  ...
  std::vector<std::string>
      dataDirs;  //!< Directory paths where Trt data files are stored
  std::vector<std::string> inputTensorNames;
  std::vector<std::string> outputTensorNames;
};

//!
//! \brief The CaffeTrtParams structure groups the additional parameters
//! required by
//!         networks that use caffe
//!
struct CaffeTrtParams : public TrtParams {
  std::string
...
//!
//! \brief The OnnxTrtParams structure groups the additional parameters
//! required by
//!         networks that use ONNX
//!
struct OnnxTrtParams : public TrtParams {
  std::string onnxFileName;  //!< Filename of ONNX file of a network
};

//!
//! \brief The UffTrtParams structure groups the additional parameters
//! required by
//!         networks that use Uff
//!
struct UffTrtParams : public TrtParams {
