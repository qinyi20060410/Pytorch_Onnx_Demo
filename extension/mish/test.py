'''
Author: your name
Date: 2021-03-16 17:41:15
LastEditTime: 2021-03-16 17:41:16
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /Demo/extension/mish/test.py
'''
import pytest
import torch
...
def test_backward(test_input):
    from mish import mish_backward
...
def test_function(test_input):
    from mish import MishCudaFunction
